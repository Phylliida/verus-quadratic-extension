    ...
    decreases f, 4nat,
{
    ...
    //  else: neg(a1*a2) ≥ 0. Need square_le_implies_le to show dd*b1*b2 ≥ neg(a1*a2).
    //  TODO: implement the le_mul chain for the neg case.
    //  For now: Z3 should derive from structural expansion.
}
